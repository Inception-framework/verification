...
__attribute__((naked))
void main(void){
  __asm volatile("mov	R8,#8"); 
  __asm volatile("push	{R3}"); 
  __asm volatile("sub	sp, #28"); 
  __asm volatile("add	R3, sp, #0"); 
  __asm volatile("str	R8, [R3, #4]"); 
  __asm volatile("movs	R9, #0"); 
  __asm volatile("str	R9, [R3, #20]"); 
  __asm volatile("movs	R9, #1"); 
  __asm volatile("str	R9, [R3, #16]"); 
  __asm volatile("movs	R9, #0"); 
  __asm volatile("str	R9, [R3, #8]"); 
  __asm volatile("b.n	fibonaccix38"); 
  __asm volatile("fibonaccix16:"); 
  __asm volatile("ldr	R9, [R3, #8]"); 
  __asm volatile("cmp	R9, #1"); 
  __asm volatile("bgt.n	fibonaccix22"); 
  __asm volatile("ldr	R9, [R3, #8]"); 
  __asm volatile("str	R9, [R3, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R1, [R3, #20]"); 
  __asm volatile("ldr	R9, [R3, #16]"); 
  __asm volatile("add	R9, R1"); 
  __asm volatile("str	R9, [R3, #12]"); 
  __asm volatile("ldr	R9, [R3, #16]"); 
  __asm volatile("str	R9, [R3, #20]"); 
  __asm volatile("ldr	R9, [R3, #12]"); 
  __asm volatile("str	R9, [R3, #16]"); 
  ...
  __asm volatile("ldr	R1, [R3, #8]"); 
  __asm volatile("ldr	R9, [R3, #4]"); 
