...
void main(void){
  ...
  __asm volatile("ldr	R8, [R9, #20]"); 
  __asm volatile("ldr	R11, [R9, #16]"); 
  __asm volatile("add	R11, R8"); 
  __asm volatile("str	R11, [R9, #12]"); 
  __asm volatile("ldr	R11, [R9, #16]"); 
  __asm volatile("str	R11, [R9, #20]"); 
  ...
  __asm volatile("ldr	R8, [R9, #8]"); 
  __asm volatile("ldr	R11, [R9, #4]"); 
  __asm volatile("cmp	R8, R11"); 
