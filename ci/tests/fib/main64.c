...
void main(void){
  ...
  __asm volatile("str	R5, [R3, #20]"); 
  __asm volatile("movs	R5, #1"); 
  __asm volatile("str	R5, [R3, #16]"); 
  __asm volatile("movs	R5, #0"); 
  __asm volatile("str	R5, [R3, #8]"); 
  ...
  __asm volatile("ldr	R5, [R3, #8]"); 
  __asm volatile("str	R5, [R3, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R6, [R3, #20]"); 
  __asm volatile("ldr	R5, [R3, #16]"); 
  __asm volatile("add	R5, R6"); 
  __asm volatile("str	R5, [R3, #12]"); 
  __asm volatile("ldr	R5, [R3, #16]"); 
  __asm volatile("str	R5, [R3, #20]"); 
  __asm volatile("ldr	R5, [R3, #12]"); 
  __asm volatile("str	R5, [R3, #16]"); 
