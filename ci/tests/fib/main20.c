...
void main(void){
  ...
  __asm volatile("str	R2, [R10, #4]"); 
  __asm volatile("movs	R8, #0"); 
  __asm volatile("str	R8, [R10, #20]"); 
  __asm volatile("movs	R8, #1"); 
  __asm volatile("str	R8, [R10, #16]"); 
  __asm volatile("movs	R8, #0"); 
  __asm volatile("str	R8, [R10, #8]"); 
  ...
  __asm volatile("ldr	R8, [R10, #8]"); 
  __asm volatile("str	R8, [R10, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R0, [R10, #20]"); 
  __asm volatile("ldr	R8, [R10, #16]"); 
  __asm volatile("add	R8, R0"); 
  __asm volatile("str	R8, [R10, #12]"); 
  __asm volatile("ldr	R8, [R10, #16]"); 
  __asm volatile("str	R8, [R10, #20]"); 
  __asm volatile("ldr	R8, [R10, #12]"); 
  __asm volatile("str	R8, [R10, #16]"); 
  ...
  __asm volatile("ldr	R0, [R10, #8]"); 
  __asm volatile("ldr	R8, [R10, #4]"); 
