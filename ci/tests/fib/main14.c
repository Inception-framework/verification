...
__attribute__((naked))
void main(void){
  __asm volatile("mov	R5,#8"); 
  __asm volatile("push	{R7}"); 
  __asm volatile("sub	sp, #28"); 
  __asm volatile("add	R7, sp, #0"); 
  __asm volatile("str	R5, [R7, #4]"); 
  __asm volatile("movs	R10, #0"); 
  __asm volatile("str	R10, [R7, #20]"); 
  __asm volatile("movs	R10, #1"); 
  __asm volatile("str	R10, [R7, #16]"); 
  __asm volatile("movs	R10, #0"); 
  __asm volatile("str	R10, [R7, #8]"); 
  __asm volatile("b.n	fibonaccix38"); 
  __asm volatile("fibonaccix16:"); 
  __asm volatile("ldr	R10, [R7, #8]"); 
  __asm volatile("cmp	R10, #1"); 
  __asm volatile("bgt.n	fibonaccix22"); 
  __asm volatile("ldr	R10, [R7, #8]"); 
  __asm volatile("str	R10, [R7, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R1, [R7, #20]"); 
  __asm volatile("ldr	R10, [R7, #16]"); 
  __asm volatile("add	R10, R1"); 
  __asm volatile("str	R10, [R7, #12]"); 
  __asm volatile("ldr	R10, [R7, #16]"); 
  __asm volatile("str	R10, [R7, #20]"); 
  __asm volatile("ldr	R10, [R7, #12]"); 
  __asm volatile("str	R10, [R7, #16]"); 
