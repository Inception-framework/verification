...
void main(void){
  ...
  __asm volatile("str	R12, [R9, #20]"); 
  __asm volatile("movs	R12, #1"); 
  __asm volatile("str	R12, [R9, #16]"); 
  __asm volatile("movs	R12, #0"); 
  __asm volatile("str	R12, [R9, #8]"); 
  __asm volatile("b.n	fibonaccix38"); 
  __asm volatile("fibonaccix16:"); 
  __asm volatile("ldr	R12, [R9, #8]"); 
  __asm volatile("cmp	R12, #1"); 
  __asm volatile("bgt.n	fibonaccix22"); 
  __asm volatile("ldr	R12, [R9, #8]"); 
  __asm volatile("str	R12, [R9, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R6, [R9, #20]"); 
  __asm volatile("ldr	R12, [R9, #16]"); 
  __asm volatile("add	R12, R6"); 
  __asm volatile("str	R12, [R9, #12]"); 
  __asm volatile("ldr	R12, [R9, #16]"); 
  __asm volatile("str	R12, [R9, #20]"); 
  __asm volatile("ldr	R12, [R9, #12]"); 
  __asm volatile("str	R12, [R9, #16]"); 
