...
__attribute__((naked))
void main(void){
  __asm volatile("mov	R7,#9"); 
  __asm volatile("push	{R11}"); 
  __asm volatile("sub	sp, #28"); 
  __asm volatile("add	R11, sp, #0"); 
  __asm volatile("str	R7, [R11, #4]"); 
  __asm volatile("movs	R2, #0"); 
  __asm volatile("str	R2, [R11, #20]"); 
  __asm volatile("movs	R2, #1"); 
  __asm volatile("str	R2, [R11, #16]"); 
  __asm volatile("movs	R2, #0"); 
  __asm volatile("str	R2, [R11, #8]"); 
  ...
  __asm volatile("ldr	R2, [R11, #8]"); 
  __asm volatile("str	R2, [R11, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R9, [R11, #20]"); 
  __asm volatile("ldr	R2, [R11, #16]"); 
  __asm volatile("add	R2, R9"); 
  __asm volatile("str	R2, [R11, #12]"); 
  __asm volatile("ldr	R2, [R11, #16]"); 
  __asm volatile("str	R2, [R11, #20]"); 
  __asm volatile("ldr	R2, [R11, #12]"); 
  __asm volatile("str	R2, [R11, #16]"); 
