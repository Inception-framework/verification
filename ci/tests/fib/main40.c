...
void main(void){
  ...
  __asm volatile("str	R11, [R7, #4]"); 
  __asm volatile("movs	R2, #0"); 
  __asm volatile("str	R2, [R7, #20]"); 
  __asm volatile("movs	R2, #1"); 
  __asm volatile("str	R2, [R7, #16]"); 
  __asm volatile("movs	R2, #0"); 
  __asm volatile("str	R2, [R7, #8]"); 
  ...
  __asm volatile("ldr	R2, [R7, #8]"); 
  __asm volatile("str	R2, [R7, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R3, [R7, #20]"); 
  __asm volatile("ldr	R2, [R7, #16]"); 
  __asm volatile("add	R2, R3"); 
  __asm volatile("str	R2, [R7, #12]"); 
  __asm volatile("ldr	R2, [R7, #16]"); 
  __asm volatile("str	R2, [R7, #20]"); 
  __asm volatile("ldr	R2, [R7, #12]"); 
  __asm volatile("str	R2, [R7, #16]"); 
