...
void main(void){
  ...
  __asm volatile("str	R3, [R4, #20]"); 
  __asm volatile("movs	R3, #1"); 
  __asm volatile("str	R3, [R4, #16]"); 
  __asm volatile("movs	R3, #0"); 
  __asm volatile("str	R3, [R4, #8]"); 
  ...
  __asm volatile("ldr	R3, [R4, #8]"); 
  __asm volatile("str	R3, [R4, #12]"); 
  __asm volatile("b.n	fibonaccix32"); 
  __asm volatile("fibonaccix22:"); 
  __asm volatile("ldr	R10, [R4, #20]"); 
  __asm volatile("ldr	R3, [R4, #16]"); 
  __asm volatile("add	R3, R10"); 
  __asm volatile("str	R3, [R4, #12]"); 
  __asm volatile("ldr	R3, [R4, #16]"); 
  __asm volatile("str	R3, [R4, #20]"); 
  __asm volatile("ldr	R3, [R4, #12]"); 
  __asm volatile("str	R3, [R4, #16]"); 
  ...
  __asm volatile("ldr	R3, [R4, #4]"); 
  __asm volatile("cmp	R10, R3"); 
