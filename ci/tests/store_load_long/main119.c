...
void foo(void){
  ...
  __asm volatile("STMDB R9!, {R10, R7, R11, R10, R1, R10, R0, R7, R4, R8, R3, R3, R12, R7, R8, R8}");
  ...
  __asm volatile("LDMDB R9!, {R10, R7, R11, R10, R1, R10, R0, R7, R4, R8, R3, R3, R12, R7, R8, R8}");
  #ifndef KLEE
  while(1);
  #else
